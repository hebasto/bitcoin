...
static const std::vector<CAddress> fixture_addresses({
    CAddress{
        CService(CNetAddr(CNetAddr::ipv6_loopback), 0 /* port */),
        NODE_NONE,
        NodeSeconds{0x4966bc61s}, /* Fri Jan  9 02:54:25 UTC 2009 */
    },
    CAddress{
        CService(CNetAddr(CNetAddr::ipv6_loopback), 0x00f1 /* port */),
        NODE_NETWORK,
        NodeSeconds{0x83766279s}, /* Tue Nov 22 11:22:33 UTC 2039 */
    },
    CAddress{
        CService(CNetAddr(CNetAddr::ipv6_loopback), 0xf1f2 /* port */),
