...
BOOST_AUTO_TEST_CASE(fsbridge_fstream)
{
    ...
    {
        std::ofstream file{std::filesystem::path{tmpfile1}};
        file << "bitcoin";
    }
    {
        std::ifstream file{std::filesystem::path{tmpfile2}};
        std::string input_buffer;
        file >> input_buffer;
        BOOST_CHECK_EQUAL(input_buffer, "bitcoin");
    }
    {
        std::ifstream file{std::filesystem::path{tmpfile1}, std::ios_base::in | std::ios_base::ate};
        std::string input_buffer;
        file >> input_buffer;
        BOOST_CHECK_EQUAL(input_buffer, "");
    }
    {
        std::ofstream file{std::filesystem::path{tmpfile2}, std::ios_base::out | std::ios_base::app};
        file << "tests";
    }
    {
        std::ifstream file{std::filesystem::path{tmpfile1}};
        std::string input_buffer;
        file >> input_buffer;
        BOOST_CHECK_EQUAL(input_buffer, "bitcointests");
    }
    {
        std::ofstream file{std::filesystem::path{tmpfile2}, std::ios_base::out | std::ios_base::trunc};
        file << "bitcoin";
    }
    {
        std::ifstream file{std::filesystem::path{tmpfile1}};
...
BOOST_AUTO_TEST_CASE(rename)
{
    ...
    {
        std::ofstream file{std::filesystem::path{path1}};
        file << path1_contents;
    }

    {
        std::ofstream file{std::filesystem::path{path2}};
        file << path2_contents;
    }
