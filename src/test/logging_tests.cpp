...
static std::vector<std::string> ReadDebugLogLines()
{
    ...
    std::ifstream ifs{std::filesystem::path{LogInstance().m_file_path}};
                         ...
                         std::source_location source = std::source_location::current())
{
    ...
    std::ofstream ofs(std::filesystem::path{LogInstance().m_file_path}, std::ios::out | std::ios::trunc); // clear debug log
