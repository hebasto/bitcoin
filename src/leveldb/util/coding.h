...
// TODO(costan): Remove the fast paths based on
//               std::memcpy when MSVC learns to optimize the generic code.
//
...
inline void EncodeFixed32(char* dst, uint32_t value) {
  ...
  // Clang and gcc optimize this to a single mov / str instruction.
