...
void AddressBookTests::addressBookTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping AddressBookTests on Windows statically linked build with 'minimal' platform set due to Qt bugs. "
              "To run AddressBookTests, set QT_QPA_PLATFORM=windows or link binaries dynamically.");
        return;
    }
#endif
