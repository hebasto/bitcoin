...
if(MULTIPROCESS)
  find_package(libmultiprocess-bin REQUIRED HINTS ${CMAKE_FIND_ROOT_PATH}/native/lib/cmake)
  cross_pkg_check_modules(capnp REQUIRED capnp IMPORTED_TARGET)
  add_library(CapnProto::capnp ALIAS PkgConfig::capnp)
  cross_pkg_check_modules(capnp-rpc REQUIRED capnp-rpc IMPORTED_TARGET)
  add_library(CapnProto::capnp-rpc ALIAS PkgConfig::capnp-rpc)
  cross_pkg_check_modules(kj REQUIRED kj IMPORTED_TARGET)
  add_library(CapnProto::kj ALIAS PkgConfig::kj)
  cross_pkg_check_modules(kj-async REQUIRED kj-async IMPORTED_TARGET)
  add_library(CapnProto::kj-async ALIAS PkgConfig::kj-async)
  find_package(libmultiprocess-lib REQUIRED HINTS ${CMAKE_FIND_ROOT_PATH}/lib/cmake)
  if(libmultiprocess-bin_FOUND AND libmultiprocess-lib_FOUND)
    set(MULTIPROCESS ON)
