...
function(try_append_cxx_flags flags)
  ...
  set(CMAKE_REQUIRED_FLAGS "${flags} ${BITCOIN_COMPILE_WERROR_FLAG}")
...
function(check_compile_werror_flag)
  if(NOT DEFINED CACHE{BITCOIN_COMPILE_WERROR_FLAG})
    if(MSVC)
      set(compile_werror_flag "/WX /options:strict")
    else()
      set(compile_werror_flag "-Werror")
    endif()
    try_append_cxx_flags("${compile_werror_flag}" RESULT_VAR cxx_supports_werror_flag)
    if(NOT cxx_supports_werror_flag)
      set(compile_werror_flag "")
    endif()
    set(BITCOIN_COMPILE_WERROR_FLAG "${compile_werror_flag}" CACHE INTERNAL "")
  endif()
endfunction()

check_compile_werror_flag()
