...
function(print_flags_per_config config indent dots)
  ...
  set(hardening_nondebug_compile_options)
  if(TARGET hardening_interface_nondebug AND NOT config STREQUAL "Debug")
    get_target_interface(hardening_nondebug_compile_options hardening_interface_nondebug COMPILE_OPTIONS)
  endif()
  ...
  string(STRIP "${combined_c_flags} ${hardening_nondebug_compile_options}" combined_c_flags)
  ...
  string(STRIP "${combined_cxx_flags} ${hardening_nondebug_compile_options}" combined_cxx_flags)
