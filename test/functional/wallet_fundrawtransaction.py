...
class RawTransactionsTest(BitcoinTestFramework):
    ...
    def test_change_position(self):
        ...
        rawmatch = self.nodes[2].createrawtransaction([], {self.nodes[2].getnewaddress():Decimal("50")})
    ...
    def test_option_feerate(self):
        ...
        inputs = []
        outputs = {node.getnewaddress() : Decimal("1")}
    ...
    def test_address_reuse(self):
        ...
        rawtx = self.nodes[3].createrawtransaction(inputs=[], outputs={self.nodes[3].getnewaddress(): Decimal("1")})
    ...
    def test_option_subtract_fee_from_outputs(self):
        ...
        inputs = []
        outputs = {self.nodes[2].getnewaddress(): Decimal("1")}
        rawtx = self.nodes[3].createrawtransaction(inputs, outputs)
    ...
    def test_subtract_fee_with_presets(self):
        ...
        rawtx = self.nodes[0].createrawtransaction([utxo], [{self.nodes[0].getnewaddress(): Decimal("5")}])
    ...
    def test_external_inputs(self):
        ...
        self.nodes[0].sendtoaddress(wallet.getnewaddress(), Decimal("10"))
    ...
    def test_add_inputs_default_value(self):
        ...
        inputs = []
        outputs = {self.nodes[1].getnewaddress(): Decimal("8")}
    ...
    def test_weight_calculation(self):
        ...
        self.nodes[0].sendtoaddress(wallet.getnewaddress(address_type="bech32"), Decimal("5"))
        self.generate(self.nodes[0], 1)

        rawtx = wallet.createrawtransaction([utxo], [{self.nodes[0].getnewaddress(address_type="bech32"): Decimal("8")}])
        ...
        rawtx = wallet.createrawtransaction([ext_utxo], [{self.nodes[0].getnewaddress(): Decimal("13")}])
    ...
    def test_input_confs_control(self):
        ...
        for _ in range(2):
            self.nodes[2].sendmany("", {wallet.getnewaddress():Decimal("1"), wallet.getnewaddress():Decimal("1")})
            self.generate(self.nodes[2], 1)
