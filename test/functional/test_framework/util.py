...
def write_config(config_path, *, n, chain, extra_config="", disable_autoconnect=True):
    ...
    with open(config_path, 'w') as f:
        ...
        #  num_p2p_bind = 2                   // Maximum number of bound P2P interfaces (-bind and -whitebind) used in a test.
        ...
        #    = 151 + 8 + 2 + 2 + 16 = 179;
        #  num_p2p_max_connections = available_fds - min_required_fds = 256 - 179 = 77;
        f.write("maxconnections=77\n")
