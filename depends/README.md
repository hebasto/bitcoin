...
Common linux dependencies:
    ...
    sudo apt-get install automake binutils bison bsdmainutils build-essential cmake curl libtool patch pkg-config python3 patch bison

No more dependencies are required to build dependencies for the native architecture.
