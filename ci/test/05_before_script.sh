...
if [ -n "$ANDROID_TOOLS_URL" ]; then
  ...
  DOCKER_EXEC mv "${ANDROID_HOME}/cmdline-tools/cmdline-tools" "${ANDROID_HOME}/cmdline-tools/latest"
  DOCKER_EXEC "yes | ${ANDROID_HOME}/cmdline-tools/latest/bin/sdkmanager --install \"build-tools;${ANDROID_BUILD_TOOLS_VERSION}\" \"platform-tools\" \"platforms;android-${ANDROID_API_LEVEL}\" \"ndk;${ANDROID_NDK_VERSION}\""
fi
