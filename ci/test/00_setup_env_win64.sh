...
export CI_BASE_PACKAGES="cmake diffutils gawk make libtool patch procps-ng rsync ucrt64-gcc-c++ util-linux which"
export HOST=x86_64-w64-mingw32ucrt
export DEP_OPTS="CC=/usr/bin/${HOST}-gcc CXX=/usr/bin/${HOST}-g++ MAKE=gmake NO_QT=1"
