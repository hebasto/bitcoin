...
export NO_DEPENDS=1
export GOAL="install"
export BITCOIN_CONFIG="--enable-zmq --disable-wallet --with-gui=qt5 CPPFLAGS=-DARENA_DEBUG --with-sanitizers=thread --disable-hardening --disable-asm CC=clang-9 CXX=clang++-9"
