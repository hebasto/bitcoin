...
export DEP_OPTS="build_CC=clang build_CXX=clang++ LDFLAGS='-fuse-ld=lld' AR=llvm-ar-${APT_LLVM_V} STRIP=llvm-strip-${APT_LLVM_V} NM=llvm-nm-${APT_LLVM_V} RANLIB=llvm-ranlib-${APT_LLVM_V}"
export GOAL="install"
