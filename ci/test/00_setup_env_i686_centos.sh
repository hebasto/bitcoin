...
export DOCKER_PACKAGES="gcc-c++ glibc-devel.x86_64 libstdc++-devel.x86_64 glibc-devel.i686 libstdc++-devel.i686 ccache libtool make git python python3 python3-zmq which patch lbzip2 dash rsync coreutils"
export GOAL="install"
