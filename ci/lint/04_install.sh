...
${CI_RETRY_EXE} python --disable-pip-version-check -m pip install codespell==2.2.1
${CI_RETRY_EXE} python --disable-pip-version-check -m pip install flake8==4.0.1
${CI_RETRY_EXE} python --disable-pip-version-check -m pip install mypy==0.942
${CI_RETRY_EXE} python --disable-pip-version-check -m pip install pyzmq==22.3.0
${CI_RETRY_EXE} python --disable-pip-version-check -m pip install vulture==2.3

SHELLCHECK_VERSION=v0.8.0
${CI_RETRY_EXE} apt-get install -y xz-utils
