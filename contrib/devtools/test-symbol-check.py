...
class TestSymbolChecks(unittest.TestCase):
    ...
    def test_PE(self):
        ...
        self.assertEqual(call_symbol_check(cxx, source, executable, ['-lpdh', '-Wl,--major-subsystem-version', '-Wl,10', '-Wl,--minor-subsystem-version', '-Wl,0']),
        ...
        self.assertEqual(call_symbol_check(cxx, source, executable, ['-lole32', '-Wl,--major-subsystem-version', '-Wl,10', '-Wl,--minor-subsystem-version', '-Wl,0']),
                (0, ''))
