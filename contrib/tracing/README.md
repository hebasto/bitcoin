...
```
$ python3 contrib/tracing/p2p_monitor.py ./build/bin/bitcoind
```
...
```
$ python3 contrib/tracing/log_raw_p2p_msgs.py ./build/bin/bitcoind
```
...
```bash
$ python3 contrib/tracing/log_utxocache_flush.py ./build/bin/bitcoind
```
...
```console
$ python3 contrib/tracing/mempool_monitor.py ./build/bin/bitcoind
```
