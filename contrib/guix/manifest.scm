...
;; While mingw-w64 is packaged in Guix, we maintain our
;; own variant to use the UCRT runtime.
;; Based on upstream:
;;  - commit: 8e874ded5c89091581a100c3150a084b9ae18f8f
;;  - source file: gnu/packages/mingw.scm
