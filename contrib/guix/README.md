...
1. Since only Windows and macOS build outputs require codesigning, the `HOSTS`
   environment variable will have a sane default value of `x86_64-w64-mingw32ucrt
...
```sh
env HOSTS='x86_64-w64-mingw32ucrt x86_64-apple-darwin' ./contrib/guix/guix-build
```
...
* _**HOSTS**_
  ...
  x86\_64-w64-mingw32ucrt x86\_64-apple-darwin arm64-apple-darwin")_
